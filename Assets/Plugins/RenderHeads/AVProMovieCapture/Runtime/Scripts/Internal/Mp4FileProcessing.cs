	...
	*/
	...
	public class MP4FileProcessing
	{
		public struct Options
		{
			...
			{
				return (applyFastStart || applyStereoMode || applySphericalVideoLayout || applyMoveCaptureFile);
			}
		...
		public static bool ProcessFile(string filePath, bool keepBackup, Options options)
		{
			...
			if(result)
			{
				...
				{
					Debug.LogFormat("[AVProMovieCapture] - Moving file from: '{0}', to: '{1}'", filePath, options.finalCaptureFilePath);
