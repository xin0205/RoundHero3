...
{
    public class PassEventSetter : MonoBehaviour, IPointerClickHandler, IPointerDownHandler, IPointerUpHandler,
        IPointerEnterHandler, IPointerExitHandler, IPointerMoveHandler
    {
        ...
        {
            PassEvent(eventData, ExecuteEvents.pointerEnterHandler);
            PassEvent(eventData, ExecuteEvents.pointerMoveHandler);
