...
namespace RoundHero
{
    public static class SoundExtension
    {
        ...
        public static int? PlayUISound(this SoundComponent soundComponent, EUISound uiSoundId, object userData = null)
        {
            IDataTable<DRUISound> dtUISound = GameEntry.DataTable.GetDataTable<DRUISound>();
            DRUISound drUISound = dtUISound.GetDataRow((int)uiSoundId);
            if (drUISound == null)
            {
