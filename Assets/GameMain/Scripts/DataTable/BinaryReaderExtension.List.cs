...
namespace RoundHero
{
	public static partial class BinaryReaderExtension
	{
		...
		public static List<Vector2Int> ReadVector2IntList(this BinaryReader binaryReader)
		{
			int count = binaryReader.Read7BitEncodedInt32();
			List<Vector2Int> list = new List<Vector2Int>(count);
			for (int i = 0; i < count; i++)
			{
				list.Add(ReadVector2Int(binaryReader));
			}
			return list;
		}
		...
		public static List<EBuffID> ReadEBuffIDList(this BinaryReader binaryReader)
		{
			int count = binaryReader.Read7BitEncodedInt32();
			var list = new List<EBuffID>(count);
			for (int i = 0; i < count; i++)
			{
				list.Add(Enum.Parse<EBuffID>(binaryReader.ReadString()));
			}
			return list;
		}
		
		// public static List<ECardID> ReadEFightCardIDList(this BinaryReader binaryReader)
		// {
		// 	int count = binaryReader.Read7BitEncodedInt32();
		// 	var list = new List<ECardID>(count);
		// 	for (int i = 0; i < count; i++)
		// 	{
		// 		list.Add(Enum.Parse<ECardID>(binaryReader.ReadString()));
		// 	}
		// 	return list;
		// }
		
		public static List<EUnitCamp> ReadEUnitCampList(this BinaryReader binaryReader)
		{
			int count = binaryReader.Read7BitEncodedInt32();
			var list = new List<EUnitCamp>(count);
			for (int i = 0; i < count; i++)
			{
				list.Add(Enum.Parse<EUnitCamp>(binaryReader.ReadString()));
			}
			return list;
		}
		
		public static List<ERelativeCamp> ReadERelativeCampList(this BinaryReader binaryReader)
		{
			int count = binaryReader.Read7BitEncodedInt32();
			var list = new List<ERelativeCamp>(count);
			for (int i = 0; i < count; i++)
			{
				list.Add(Enum.Parse<ERelativeCamp>(binaryReader.ReadString()));
			}
			return list;
		}
		
		
		public static List<ETriggerTarget> ReadETriggerTargetList(this BinaryReader binaryReader)
		{
			int count = binaryReader.Read7BitEncodedInt32();
			var list = new List<ETriggerTarget>(count);
			for (int i = 0; i < count; i++)
			{
				list.Add(Enum.Parse<ETriggerTarget>(binaryReader.ReadString()));
			}
			return list;
		}
		
		public static List<EUnitRole> ReadEUnitRoleList(this BinaryReader binaryReader)
		{
			int count = binaryReader.Read7BitEncodedInt32();
			var list = new List<EUnitRole>(count);
			for (int i = 0; i < count; i++)
			{
				list.Add(Enum.Parse<EUnitRole>(binaryReader.ReadString()));
			}
			return list;
		}
		
		// public static List<ECardID> ReadECardIDList(this BinaryReader binaryReader)
		// {
		// 	int count = binaryReader.Read7BitEncodedInt32();
		// 	var list = new List<ECardID>(count);
		// 	for (int i = 0; i < count; i++)
		...
		public static List<EAttackTarget> ReadEAttackTargetList(this BinaryReader binaryReader)
		{
			int count = binaryReader.Read7BitEncodedInt32();
			var list = new List<EAttackTarget>(count);
			for (int i = 0; i < count; i++)
			{
				list.Add(Enum.Parse<EAttackTarget>(binaryReader.ReadString()));
			}
			return list;
		}
		
		public static List<EBuffType> ReadEBuffTypeList(this BinaryReader binaryReader)
		{
			int count = binaryReader.Read7BitEncodedInt32();
			var list = new List<EBuffType>(count);
			for (int i = 0; i < count; i++)
			{
				list.Add(Enum.Parse<EBuffType>(binaryReader.ReadString()));
			}
			return list;
		}
