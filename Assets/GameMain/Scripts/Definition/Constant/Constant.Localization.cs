...
namespace RoundHero
{
    public static partial class Constant
    {
        public static class Localization
        {
            ...
            public const string FuneName = "FuneName.{0}";
            public const string FuneDesc = "FuneDesc.{0}";
            ...
            public const string Message_ConfirmRemoveCard = "Message.ConfirmRemoveCard";
            ...
            public const string UI_BattleMode = "UI.BattleMode";
            ...
            public const string  Tips_SelectMoveUnit = "Tips.SelectMoveUnit";
            ...
            public const string  Tips_SelectTargetUnit = "Tips.SelectTargetUnit";
            public const string  Tips_SelectTargetPos = "Tips.SelectTargetPos";
