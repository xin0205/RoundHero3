...
namespace RoundHero
{
    public class PositionConvert
    {
        ...
        public static Vector2 UIPointToScreenPoint(Vector3 worldPoint)
        {
            ...
            Camera uiCamera = AreaController.Instance.UICamera;
        ...
        public static Vector2 WorldPointToUILocalPoint(RectTransform parentRT, Vector3 worldPoint)
        {
            var screenPoint = PositionConvert.WorldPointToScreenPoint(worldPoint);
            var uiLocalPoint = PositionConvert.ScreenPointToUILocalPoint(
                parentRT,
                screenPoint);
