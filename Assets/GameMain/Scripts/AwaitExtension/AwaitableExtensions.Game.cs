...
namespace UGFExtensions.Await
{
    public partial class AwaitableExtensions
    {
        ...
        /// 显示实体（可等待）
        /// </summary>
//         public static Task<Entity> ShowEntityAsync(this EntityComponent entityComponent, int entityId, Type logicType,
//             string entityAssetName, string entityGroupName,
//             int priority,
//             EntityData data)
//         {
// #if UNITY_EDITOR
...
//             entityComponent.ShowEntity(entityId, logicType, entityAssetName, entityGroupName, priority, data);
//             return tcs.Task;
//         }
