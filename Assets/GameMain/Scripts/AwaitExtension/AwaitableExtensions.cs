...
namespace UGFExtensions.Await
{
    public static partial class AwaitableExtensions
    {
        ...
        public static async Task<Sprite> LoadSpriteAsync(this ResourceComponent resourceComponent, string assetName)
        {
            var texture2D = await resourceComponent.LoadAssetAsync<Texture2D>(assetName);
