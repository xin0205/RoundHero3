...
namespace RoundHero
{
    ...
    public class FightManager : Singleton<FightManager>
    {
        ...
        public void CacheConsumeCardEnergy(int cardID, int unitID = -1)
        {
            ...
            {
                FightManager.Instance.ChangeHP(FightManager.Instance.PlayerData.BattleHero, -cardEnergy,
        ...
        private void CacheRoundStartBuffDatas()
        {
            foreach (var kv in BattleUnitDatas)
            {
                ...
                if (hurtRoundStartCount > 0)
                {
                    ...
                    {
                        var triggerData = FightManager.Instance.BattleRoleAttribute(kv.Key, kv.Key, kv.Key,
            ...
            List<TriggerData> triggerDatas, List<MoveUnitStateData> preMoveUnitStateDatas = null)
        {
            ...
            if (bePassUnitAttackPassUs > 0 && passUnit.UnitCamp == bePassUnit.UnitCamp)
            {
                    ...
                    !GameUtility.ContainRoundState(RoundFightData.GamePlayData, EBuffID.Spec_CurseUnEffect))
                {
                    ...
                    var battlePlayerData =
                        FightManager.Instance.RoundFightData.GamePlayData.BattleData.GetBattlePlayerData(bePassUnit
                            .UnitCamp);
                    ...
                    var triggerData = FightManager.Instance.BattleRoleAttribute(bePassUnit.ID,
            ...
            if (passUnitAttackPassUs > 0 && passUnit.UnitCamp == bePassUnit.UnitCamp)
            {
                    ...
                    !GameUtility.ContainRoundState(RoundFightData.GamePlayData, EBuffID.Spec_CurseUnEffect))
                {
                    ...
                    var battlePlayerData =
                        FightManager.Instance.RoundFightData.GamePlayData.BattleData.GetBattlePlayerData(
                            passUnit.UnitCamp);
                    if (battlePlayerData.RoundBuffs.Contains(EBuffID.Spec_AtkPassEnemyAddDmg_AtkPassUsAddDmg))
                    {
                        value += value < 0 ? 1 : 0;
                    ...
                    var triggerData = FightManager.Instance.BattleRoleAttribute(passUnit.ID,
            ...
            if (bePassUnitAttackPassEnemy > 0 && passUnit.UnitCamp != bePassUnit.UnitCamp)
            {
                if (!ContainsMoveUnitStateData(preMoveUnitStateDatas, EUnitState.AtkPassEnemy, true))
                {
                    ...
                    var triggerData = FightManager.Instance.BattleRoleAttribute(bePassUnit.ID, bePassUnit.ID,
            ...
            if (passUnitAttackPassEnemy > 0 && passUnit.UnitCamp != bePassUnit.UnitCamp)
            {
                if (!ContainsMoveUnitStateData(preMoveUnitStateDatas, EUnitState.AtkPassEnemy, false))
                {
                    ...
                    var triggerData = FightManager.Instance.BattleRoleAttribute(passUnit.ID, passUnit.ID,
            ...
            Dictionary<int, MoveActionData> unitMoveDatas)
        {
            ...
            for (int i = 0; i < movePaths.Count; i++)
            {
                ...
                if (hurtEachMoveCount > 0 && i > 0)
                {
                    if (!GameUtility.ContainRoundState(RoundFightData.GamePlayData, EBuffID.Spec_CurseUnEffect))
                    {
                        var hurtEachMoveTriggerData = FightManager.Instance.BattleRoleAttribute(passUnit.ID,
                            passUnit.ID,
                            passUnit.ID,
                ...
                {
                    var collisionTriggerData = FightManager.Instance.BattleRoleAttribute(unitID, unitID,
                    ...
                    var collisionTriggerData2 = FightManager.Instance.BattleRoleAttribute(bePassUnit.ID, bePassUnit.ID,
        ...
        private void CurHPTriggerData(TriggerData triggerData, List<TriggerData> triggerDatas)
        {
            ...
            if (triggerValue < 0)
            {
                ...
                else
                {
                    if (triggerData.OwnUnitID > 0 && triggerData.OwnUnitID == triggerData.ActionUnitID)
                    {
                        ...
                        if (ownUnit != null && triggerData.UnitState == EUnitState.Empty)
                        {
                            ...
                            {
                                var subHurtAddDamageData = FightManager.Instance.Unit_State(triggerDatas, effectUnitData.ID,
                    ...
                    if (effectUnitData.GetAllStateCount(EUnitState.CounterAtk) > 0)
                    {
                        ...
                        var counterAttackTriggerData = FightManager.Instance.BattleRoleAttribute(effectUnitData.ID,
                        ...
                        var subCounterAttackTriggerData = FightManager.Instance.Unit_State(triggerDatas, effectUnitData.ID,
                    ...
                    if (actionUnitData != null && actionUnitData.GetStateCount(EUnitState.RecoverHP) > 0)
                    {
                        ...
                        var recoverHPTriggerData = FightManager.Instance.BattleRoleAttribute(actionUnitData.ID,
                    ...
                    FightManager.Instance.ChangeHP(effectUnitData, triggerValue, EHPChangeType.Unit, true,
                ...
                {
                    var addDamageTriggerData = FightManager.Instance.Unit_State(triggerDatas, effectUnitData.ID,
                ...
                {
                    var subDamageTriggerData = FightManager.Instance.Unit_State(triggerDatas, effectUnitData.ID,
            ...
            else
            {
                ...
                FightManager.Instance.ChangeHP(effectUnitData, triggerValue,
            ...
            EUnitState unitState, float attributeValue, ETriggerDataType triggerDataType)
        {
            ...
            if (Constant.Battle.EffectUnitStates[EUnitStateEffectType.Negative].Contains(unitState))
            {
                ...
                {
                    var triggerData = FightManager.Instance.BattleRoleAttribute(effectUnit.ID, effectUnit.ID,
        ...
        {
            FightManager.Instance.ActionProgress = EActionProgress.SoliderActiveAttack;
        ...
        {
            FightManager.Instance.ActionProgress = EActionProgress.SoliderAutoAttack;
        ...
        {
            FightManager.Instance.ActionProgress = EActionProgress.UseCardTrigger;
        ...
        public void MoveEffectAction(EUnitActionState unitActionState, MoveActionData moveActionData, int moveIdx, int moveUnitID)
        {
            ...
            foreach (var triggerData in triggerDatas)
            {
                ...
                if (triggerData.ActionUnitID != -1 && triggerData.EffectUnitID != triggerData.ActionUnitID)
                {
                    ...
                    if (!(!triggerData.ChangeHPInstantly && BattleHeroManager.Instance.IsHero(triggerData.EffectUnitID)))
                    {
        ...
        {
            var unit1 = FightManager.Instance.GetUnitByID(unit1ID);
            var unit2 = FightManager.Instance.GetUnitByID(unit2ID);
        ...
        public List<int> GetEffectUnitIDs(BuffData buffData, int ownUnitID, int actionUnitID, int effectUnitID, int actionUnitGridPosIdx, int actionUnitPreGridPosIdx)
        {
            ...
            var actionUnit = FightManager.Instance.GetUnitByID(actionUnitID);
        ...
        {
            var unit = FightManager.Instance.GetUnitByID(triggerData.ActionUnitID);
        ...
        {
            var effectUnit = FightManager.Instance.GetUnitByID(triggerData.EffectUnitID);
            ...
            var enemyDeadDebuffToOtherEnemy = FightManager.Instance.RoundFightData.GamePlayData.GetUsefulBless(EBlessID.EnemyDeadDebuffToOtherEnemy, BattleManager.Instance.CurUnitCamp);
        ...
        public void  CalculateUnitPaths(EUnitCamp unitCamp, List<int> actionUnitIDs, List<int> obstacleEnemies, Dictionary<int, List<int>> movePaths)
        {
            ...
            foreach (var actionUnitID in actionUnitIDs)
            {
                ...
                for (int i = 0; i < intersectList.Count; i++)
                {
                    ...
                    var realPaths =
                        FightManager.Instance.GetRunPaths(battleUnitData.GridPosIdx, intersectGridPosIdx, runPaths);
                    ...
                    case EAttackTarget.Hero:
                        unitActionRange.Sort((triggerGridPosIdx1, triggerGridPosIdx2) =>
                        {
                            var triggerRange1 = GameUtility.GetRange(triggerGridPosIdx1, buffData.TriggerRange, unitCamp,
                                buffData.TriggerUnitCamps, true);
                            var inRange1 = triggerRange1.Contains(BattleHeroManager.Instance.BattleHeroData.GridPosIdx) ? 1 : 0;
                            
                            var triggerRange2 = GameUtility.GetRange(triggerGridPosIdx2, buffData.TriggerRange, unitCamp,
                                buffData.TriggerUnitCamps, true);
                            var inRange2 = triggerRange2.Contains(BattleHeroManager.Instance.BattleHeroData.GridPosIdx) ? 1 : 0;
